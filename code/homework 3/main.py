...
cinderellas = [
    Cinderella("Alla", 15, 5),
    Cinderella("Katy", 18, 8),
    Cinderella("Anna", 19, 10),
]

# for cinderella in cinderellas:
#     print(cinderella)

prince = Prince('Nazar', 20, 10)
